...
public class WorkWithDriveData {
  ...
  protected static void printAbout(Drive service) {
    try {
   ...
   */
  protected static void printPermission(Drive service, String fileId, String permissionId) {
    try {
   ...
   */
  public List<Permission> retrievePermissions(Drive service, String fileId) {
    try {
